...
class ReportMakerForm extends StatefulWidget {
  @override
  _ReportMakerFormState createState() => _ReportMakerFormState();
}

class _ReportMakerFormState extends State<ReportMakerForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Generación de Reporte')),
      body: Form(
        key: _formKey,
