        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              sectionContent(
                  'Esta sección del aplicativo está destinada a la revision y detalle de de los diferentes modelos analiticos que procesan la data de un establecimiento \n \n'
                  'Los modelos del aplicativo son generados mediante el estudio y analisis de la data historica de una o mas sucursales\n'
                  'De igual manera, se dividen en dos categorías: \n \n'
                  'Sirena Market e Híper Market. \n\n'
                  '\nLos mismos estarán representados en la intefaz de modelos como tarjetas con algunas informaciones relevantes\n\n'
                  'Los modelos de analisis se crean, prueban y registran de forma manual por el Sysadmin.\n'),

              // Estructura de Datos y Modelos
              sectionTitle('Estructura de Datos y Modelos'),
              sectionContent(
                  'Los modelos son entrenados y alimentados para utilizar la misma data que es provista para los establecimientos\n'),
